                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('employees.store') }}" class="needs-validation" novalidate="" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <input id="code" type="hidden" class="form-control @error('code') is-invalid @enderror" name="code" required autocomplete="code" readonly="" value="{{ 'SDS'.'-'.$generateNumber }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="basic_salary" type="text" class="form-control @error('basic_salary') is-invalid @enderror" name="basic_salary" value="{{ old('basic_salary') }}" required autocomplete="basic_salary" placeholder="Contoh: 5000000">
                                        @if (count($errors) > 0)
                                            @error('basic_salary')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="start_contract" type="text" class="form-control datepicker @error('start_contract') is-invalid @enderror" name="start_contract" value="{{ old('start_contract') }}" placeholder="Contoh: 2019-05-01 (format: yyyy-mm-dd)" required autocomplete="start_contract">
                                        @if (count($errors) > 0)
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="end_of_contract" type="text" class="form-control datepicker @error('end_of_contract') is-invalid @enderror" name="end_of_contract" value="{{ old('end_of_contract') }}" placeholder="Contoh: 2019-05-01 (format: yyyy-mm-dd)" required autocomplete="end_of_contract">
                                        @if (count($errors) > 0)
                            ...
                            <div class="form-group">
                                <label>Tanda Tangan dengan Cap Sadasa</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="selectgroup w-100">
                                    <label class="selectgroup-item">
                                        <input type="radio" id="status" value="Active" class="selectgroup-input" name="status" checked="" required>
                                        <span class="selectgroup-button" for="Active" value="Active" id="status" name="status">Aktif</span>
                                    </label>
                                    <label class="selectgroup-item">
                                        <input type="radio" id="status" value="Inactive" class="selectgroup-input" name="status" required>
