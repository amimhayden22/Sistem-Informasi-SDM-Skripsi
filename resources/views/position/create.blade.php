  ...
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">Form Tambah Jabatan</div>
      </div>
    </div>

      <div class="section-body">
        <h2 class="section-title">Form Tambah Jabatan</h2>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <form action="{{ route('positions.index') }}" method="POST" class="needs-validation" novalidate="">
              @csrf
              <div class="form-group">
                <label>Nama<span class="text-danger">*</span></label>
                <input type="text" id="name" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Nama" value="{{ old('name') }}" required autocomplete="name">
                @if (count($errors) > 0)
                  @error('name')
              ...
              <div class="form-group">
                ...
                <select id="part_id" name="part_id" type="text" class="form-control select2 @error('part_id') is-invalid @enderror" value="{{ old('part_id') }}" required autocomplete="part_id">
