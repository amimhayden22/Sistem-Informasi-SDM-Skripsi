...
$('[data-confirm]').each(function() {
  ...
  me.fireModal({
    ...
    buttons: [
      ...
      {
        text: me.data('confirm-text-yes') || 'Yakin',
...
// Modal for Approve
$('[data-confirm-b]').each(function() {
  var me = $(this),
      me_data = me.data('confirm-b');
  ...
  me.fireModal({
    ...
    buttons: [
      ...
      {
        text: me.data('confirm-text-yes-b') || 'Yakin',
        class: 'btn btn-success btn-shadow btn-approved-confirm',
        handler: function() {
          eval(me.data('confirm-yes-b'));
        }
      }
    ]
  })
